...
import com.cesar20991.service.impl.TablaServiceImpl;
...
public class IndexBean implements Serializable {
	...
	@PostConstruct
	public void init() { // Se ejecuta luego del constructor - Se recomienda usar en las inyecciones de dependen7cia
		// EN este ejemplo esta a 3 niveles
